...
const RAW_EXERCISE_VARIANTS: ExerciseVariant[] = [
  ...
  ...expand("sled_leg_press", "Sled Leg Press", [
    { label: "45 Degree", equipment: "machine", core: true, id: "sled_leg_press" },
  ...
  ...expand("hip_adduction", "Hip Adduction", [
    { label: "Machine", equipment: "machine", core: true, id: "machine_hip_adduction" },
    { label: "Plate Loaded", equipment: "plate_loaded", id: "plate_loaded_hip_adduction" },
    { label: "Single Leg Machine", equipment: "machine", id: "single_leg_machine_hip_adduction" },
    { label: "Standing Cable", equipment: "cable", core: true, id: "standing_cable_hip_adduction" },
    { label: "Single Leg Cable", equipment: "cable", id: "single_leg_cable_hip_adduction" },
    { label: "Side Lying", equipment: "bodyweight", id: "side_lying_hip_adduction" },
    { label: "Copenhagen", equipment: "bodyweight", id: "copenhagen_adduction" },
    { label: "Supported Copenhagen", equipment: "bodyweight", id: "supported_copenhagen_adduction" },
    { label: "Ball Squeeze", equipment: "bodyweight", id: "ball_squeeze" },
  ], ["adductors"]),
...
const EQUIPMENT_RULES: Partial<Record<BaseId, EquipmentTag[]>> = {
  ...
  single_leg_standing_calf_raise: ["bodyweight"],
  smith_machine_standing_calf_raise: ["smith"],
  machine_standing_calf_raise: ["machine"],
  seated_calf_raise: ["machine"],
  single_leg_seated_calf_raise: ["machine"],
  leg_press_calf_raise: ["machine"],
  bent_knee_leg_press_calf_raise: ["machine"],
  donkey_calf_raise: ["machine"],
  tibialis_raise: ["bodyweight"],
  single_leg_tibialis_raise: ["bodyweight"],
  seated_tibialis_raise: ["machine"],
  band_tibialis_dorsiflexion: ["band"],
