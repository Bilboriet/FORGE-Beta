  ...
  return (
    <button
      ...
      style={{
        padding: "8px 10px",
        borderRadius: 999,
        border: "1px solid " + (active ? "rgba(var(--accentHot-rgb),0.6)" : "var(--border)"),
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          height: 40,
          borderRadius: 12,
          border: "1px solid " + (isFavorite ? "rgba(var(--accentHot-rgb),0.55)" : "var(--border)"),
              ...
              {([
                ...
                <button
                  ...
                  style={{
                    padding: "10px 12px",
                    borderRadius: 14,
                    border: "1px solid " + (catFilter === cat ? "rgba(var(--accentHot-rgb),0.55)" : "var(--border)"),
                    background: catFilter === cat ? "rgba(var(--accentHot-rgb),0.12)" : "rgba(255,255,255,0.04)",
                  ...
                  <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: 12,
                        border: "1px solid rgba(var(--accentHot-rgb),0.35)",
                        background: presetName.trim() ? "rgba(var(--accentHot-rgb),0.10)" : "rgba(255,255,255,0.04)",
